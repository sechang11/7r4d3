...
void ExecuteTrade()
{
   ...
   // Game plan: refuse submission while a session cap is hit. This is the
   // real teeth — without it you can still take trade #4 by hand.
...
void OnChartEvent(const int id, const long &lparam, const double &dparam, const string &sparam)
{
   ...
   {
      // ── Game-plan gate ──
      // Single choke point for all 26 order buttons. Exits, partials,
      // breakeven, cancel, trailing and SET SL/TP are NOT order buttons and
      // are deliberately never reachable from here.
